        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Favorites Link (Visible only to authenticated users) -->
                    @auth
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 underline dark:text-gray-300">Log in</a>
                    <a href="{{ route('register') }}" class="text-sm text-gray-700 underline ms-4 dark:text-gray-300">Register</a>
                @endauth
            </div>
